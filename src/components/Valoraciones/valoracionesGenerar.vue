  ...
  <q-card style="width: 400px;" class="q-pr-xs q-gutter-xs">
    ...
    <q-form @submit="generarValoraciones" class="q-gutter-y-xs">
      <q-select
        ...
        emit-value
      />
      <q-input outlined clearable :rules="[val => !!val || 'Campo obligatorio']" label="Fecha que se genera" stack-label :model-value="formatDate(filterR.fecha)" @update:model-value="val => filterR.fecha=val" >
