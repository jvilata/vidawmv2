          ...
          >
            <div :style="col.style">
              ...
              <q-popup-edit v-if="!['user','ts'].includes(col.name)"
                ...
                <q-input v-if="!['user','ts', 'clasificacion'].includes(col.name)" v-model="scope.value"/>
  ...
  methods: {
    ...
    deleteRecord (id) {
      this.$q.dialog({
        ...
        return this.$axios.delete(`activos/bd_act_clasificacion.php/act_clasificacion/${id}`)
          .then(response => {
